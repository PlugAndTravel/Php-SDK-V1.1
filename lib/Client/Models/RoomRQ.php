...
class RoomRQ implements ArrayAccess
{
    ...
    /**
     * Sets code
     * @param string $code Room code received in HotelAvailability response.
     * @return $this
     */
    ...
    /**
     * Sets total_price
     * @param double $total_price You can provide BookingPrice value                 OR              Sum from price breakdown, tax breakdown and room/person supplement when IsMandatory is true and ChargeType is 'Addition'
     * @return $this
     */
    ...
    /**
     * Sets meal
     * @param \PlugAndTravel\Client\Models\Meal $meal Same meal as one received in HotelAvailability request for this room
     * @return $this
     */
    ...
    /**
     * Sets tokens
     * @param \PlugAndTravel\Client\Models\Token[] $tokens Token list received in HotelAvailability request
     * @return $this
     */
    ...
    /**
     * Sets occupancy
     * @param \PlugAndTravel\Client\Models\Occupancy $occupancy Same Occupancy sent in HotelAvailability request
     * @return $this
     */
