 ...
 *
 * @category    Class */
 // @description Every room group is an option you can book, contains your searched rooms grouped.
/** 
 * @package     PlugAndTravel
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RoomGroup implements ArrayAccess
{
    /**
    ...
    protected static $swaggerTypes = array(
        'code' => 'string',
        'rooms' => '\PlugAndTravel\Client\Models\Room[]'
    );
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['rooms'] === null) {
            $invalid_properties[] = "'rooms' can't be null";
        }
    ...
    /**
     * Sets code
     * @param string $code Code that identify a particular room group. Just pass it in the next request.
     * @return $this
     */
    ...
    /**
     * Gets rooms
     * @return \PlugAndTravel\Client\Models\Room[]
     */
    ...
    /**
     * Sets rooms
     * @param \PlugAndTravel\Client\Models\Room[] $rooms
     * @return $this
     */
